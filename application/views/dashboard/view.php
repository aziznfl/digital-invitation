    <div data-elementor-type="wp-page" class="elementor elementor-43667" data-elementor-settings="[]">
        <div class="elementor-section-wrap">
                    ...
                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-502bb702 elementor-invisible" data-id="502bb702" data-element_type="column" data-settings="{&quot;animation&quot;:&quot;fadeInLeft&quot;}">
                        <div class="elementor-widget-wrap elementor-element-populated">
                                ...
                                <div class="elementor-widget-container">
                                    <h3 class="elementor-headline">
                                        <span class="elementor-headline-dynamic-wrapper elementor-headline-text-wrapper">
                                            <span class="elementor-headline-dynamic-text elementor-headline-text-active">Dita</span>
                                        </span>
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="elementor-element elementor-element-7a5eb17b elementor-widget elementor-widget-text-editor" data-id="7a5eb17b" data-element_type="widget" data-widget_type="text-editor.default">
                                <div class="elementor-widget-container">
                                    <p><b>Putri dari :</b></p>
                                    <p>Bapak Didin Saripudin</p>
                                    <p>&amp;</p>
                                    <p>Ibu Atin Susanah</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section style="background-color: #fffaf2;" class="<?php if(!$lg) echo "hide "; ?>elementor-section elementor-section-boxed">
                <div class="elementor-container elementor-column-gap-default">
                    <div class="love-gift-button">Love Gift</div>
                </div>
                <div class="elementor-container elementor-column-gap-default">
                    <div class="love-gift-intro">Tanpa mengurangi rasa hormat, bagi anda yang ingin memberikan tanda kasih kepada kami, dapat melalui:</div>
                </div>
                <div style="padding: 20px;" class="elementor-container elementor-column-gap-default">
                    <div class="love-gift-content elementor-column elementor-col-25 elementor-top-column elementor-element" data-element_type="column">
                        <div class="list-bank">
